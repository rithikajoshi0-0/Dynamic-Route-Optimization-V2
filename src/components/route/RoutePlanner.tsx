...
import OpenRouteMapComponent from '../maps/OpenRouteMapComponent';
    ...
    try {
      ...
      if (graph.nodes.length > 0) {
        ...
        if (startNode && endNode) {
          ...
          optimizedResult = {
            ...orsResult,
            path: algorithmResult.path,
            visitedNodes: algorithmResult.visitedNodes,
            algorithm: `${algorithmResult.algorithm} + OpenRouteService`,
          };
        }
      }
